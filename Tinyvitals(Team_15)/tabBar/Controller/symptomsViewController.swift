...
class symptomsViewController: UIViewController {
    ...
    @IBOutlet var symptomSuperView: UIView!
    ...
    func setupGradient() {
        ...
        // Apply to the view
        gradientLayer.frame = symptomSuperView.bounds
        symptomSuperView.layer.insertSublayer(gradientLayer, at: 0)
    }
